...
<ul id="courses">
	<li>Fall 2004
		<ul>
			...
			<li>HIST 001: World History</li>
			<li>HOPR 010: Race &amp; Ethnicity Seminar</li>
			<li>COSC 061: Programming</li>
			<li>SPAN 003: Grammar</li>
			<li>MATH 090: Discrete Mathematics</li>
		</ul>
	</li>
	<li>Spring 2005
		<ul>
			<li>ENGL 006: Honors English II</li>
			<li>COSC 065: Hardware Systems</li>
			<li>COSC 066: Data Structures &amp; Algorithms I</li>
			<li>SPAN 004: Grammar</li>
		</ul>
	<li>Fall 2005
		<ul>
			<li>ENGL 172: Shakespeare</li>
			<li>COSC 125: Programming Languages</li>
			<li>COSC 153: Database Systems</li>
			<li>SPAN 082: Conversation &amp; Writing</li>
		</ul>
	</li>
	<li>Spring 2006
		<ul>
	...
	<li>Fall 2006
		<ul>
			<li>COSC 195: Independant Study (Completed Summer '06)</li>
			<li>COSC 172: Networks &amp; Internets</li>
			<li>POSC 040: Comparative Politics</li>
			<li>POSC 060: International Politics</li>
			<li>SPAN 100: History &amp; Culture of Spain</li>
